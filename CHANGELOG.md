...
### Fixed
- Selected timeframe was ignored: reports always loaded data for the last 30 days regardless of the chosen period
- Initial data load now correctly respects the active timeframe selection in both UI 2.0 and legacy UI 1.3
